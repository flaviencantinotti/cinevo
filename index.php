            ...
            <div class="grille-avis">
                ...
                <article class="carte-avis">
                    <a href="fiche.php?id=496243" class="lien-carte">
                        ...
                        <p class="avis-texte">Bong Joon-ho ne filme pas la lutte des classes : il en filme
                            l'architecture. Chaque escalier, chaque seuil, chaque odeur trace une frontière qu'on
                            croyait abolie.</p>
                    </a>
                    <div class="avis-bas">
                ...
                <article class="carte-avis">
                    <a href="fiche.php?id=758866" class="lien-carte">
                        ...
                        <p class="avis-texte">Trois heures qui ne pèsent rien. Hamaguchi installe un théâtre dans une
                ...
                <article class="carte-avis">
                    <a href="fiche.php?id=976893" class="lien-carte">
                        ...
                        <p class="avis-texte">Vu sans y croire, ressorti changé. Wenders nettoie sa caméra avec autant
                            de soin que Hirayama nettoie ses toilettes.</p>
                    </a>
                    <div class="avis-bas">
